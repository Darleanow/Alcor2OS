...
int   kstrncmp(const char *a, const char *b, u64 n) { return strncmp(a, b, n); }
...
u32 get_block_num(
    const ext2_volume_t *v, const ext2_inode_t *inode, u32 fb)
{
  (void)v; (void)inode; (void)fb; return 0;
}
u32 alloc_file_block(
    ext2_volume_t *v, ext2_inode_t *inode, u32 fb, u32 grp)
{
  (void)v; (void)inode; (void)fb; (void)grp; return 0;
}
...
static void aligned_len_already_aligned(void **state)
{
  ...
  u32 pad = (EXT2_DIRENT_ALIGN - (base % EXT2_DIRENT_ALIGN)) % EXT2_DIRENT_ALIGN;
